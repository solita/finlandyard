...
var actors = [
  ...
  {type: 'villain', name: 'Stiff Little Finger', location: 'KEM', caught: false, freeMinutes: 0, aifn: AI.random },
  {type: 'villain', name: 'Stiff Little Finger', location: 'KAJ', caught: false, freeMinutes: 0, aifn: AI.random },
  {type: 'villain', name: 'Mr. a', location: 'KEM', caught: false, freeMinutes: 0, aifn: AI.random }
];
